...
component {
	...
	// Module Entry Point
	this.entryPoint			= "pebble";
	// Model Namespace
	this.modelNamespace		= "pebble";
	// CF Mapping
	this.cfmapping			= "pebble";
	// Module Dependencies
	...
	function configure(){
		...
		// Binder Mappings
		 binder.map("Pebble@templateEngine").to("#moduleMapping#.models.Pebble");
	...
	*/
	function onLoad(){
		controller.getWireBox().getInstance( "loader@cbjavaloader" ).appendPaths( getDirectoryFromPath( getCurrentTemplatePath() ) & "models\lib"  );
